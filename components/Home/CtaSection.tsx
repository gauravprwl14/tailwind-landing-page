    ...
    return (
        <div className='bg-electricGreen flex w-full items-center justify-center'>
            <div className='section-container md:h-64 min-h-64 md:border-t'>
                ...
                <div><button className='mt-10 p-3 px-6 pt-2 border-4 border-black bg-veryLightGray hover:bg-gray-200 rounded-lg baseline font-Poppins font-medium' onClick={handleGetInTouch}> Get in Touch</button></div>
            </div>
        </div>
    )
}
